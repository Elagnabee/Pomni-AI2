...
const client = new Client({
  phoneNumber: '201141714312', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
  ...
  // Owner 2
    { name: "emam", lid: "221307316789354@lid", jid: "201141714312@s.whatsapp.net" },
  // Owner 3
    { name: "Sukuna", jid: "201141714312@s.whatsapp.net", lid: "50414477168824@lid" },
  // Owner 4 
